class InicioController < ApplicationController
  ...
  def inicio_usr
    @lugares = {
			...
			usuario4: ["San Gabriel Amacuitlapilco, Jonacatepec","En SG se destaca el uso del perifoneo para matener a la comunidad en comunicación, su plaza generalemente estaba sola con respecto a las otras comunidades. Hay dos iglesias de las cuales de una resalta el color morado."], 
  ...
  def set_localidad
    locs = {usuario1: "Ixtlilco el grande, Tepalcingo", usuario2: "Jantetelco, Jantetelco", usuario3: "Marcelino Rodiguez, Axochiapán", usuario4: "San Gabriel Amacuitlapiclo, Jonacatepec", usuario5: "Tetela del volcán", tepalcingo: "Ixtlilco el grande, Tepalcingo", jantetelco: "Jantetelco, Jantetelco", axochiapan: "Marcelino Rodiguez, Axochiapán", jonacatepec: "San Gabriel Amacuitlapilco, Jonacatepec", tetela: "Tetela del volcán", peto: "Peto", santaelena: "Santa Elena", santahelena: "Santa Elena"}
    @loc = locs[current_user.usuario.to_sym]
  end

  def set_class
    h_class = {usuario1: "ixtlilco", usuario2: "jantetelco", usuario3: "marcelino", usuario4: "san-gabriel", usuario5: "tetela", tepalcingo: "ixtlilco", jantetelco: "jantetelco", axochiapan: "marcelino", jonacatepec: "san-gabriel", tetela: "tetela", peto: "peto", santaelena: "sta-elena", santahelena: "sta-elena"}
